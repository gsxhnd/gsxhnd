...
|---------|-------------|------------|
| [Garage](https://github.com/gsxhnd/garage) | CLI toolkit for javbus crawl & ffmpeg batch processing | Go, CLI |
| [Dubhe](https://github.com/gsxhnd/Dubhe) | High-performance MQTT Broker supporting v3/v4/v5 | Go, Networking |
| [Railgun](https://github.com/gsxhnd/railgun) | Lightweight Go HTTP web framework | Go, HTTP |
| [Stellaris](https://github.com/gsxhnd/Stellaris) | Modern proxy solution | Go, Networking |

### Demo & Learning Projects

| Project | Description | Tech Stack |
|---------|-------------|------------|
| [demo_astro](https://github.com/gsxhnd/demo_astro) | Static site builder exploration | Astro, TypeScript |
| [demo_cpp_own_redis](https://github.com/gsxhnd/demo_cpp_own_redis) | Redis-like server implementation from scratch | C++, Networking |
| [demo_go_framework](https://github.com/gsxhnd/demo_go_framework) | Go Fiber API with DI and observability | Go, Fiber, fx |
| [demo_go_sample](https://github.com/gsxhnd/demo_go_sample) | Go language experiments and snippets | Go |
| [demo_java_spring](https://github.com/gsxhnd/demo_java_spring) | Spring Boot microservices patterns | Java, Spring Boot |
| [demo_rust_axum](https://github.com/gsxhnd/demo_rust_axum) | Rust web API with Axum framework | Rust, Axum, Tokio |
